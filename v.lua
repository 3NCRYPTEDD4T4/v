...
do
    ...
    function library:New(info)
        ...
        local guibind = info.Key or info.key or info.bind or info.Bind or info.Keybind or info.keybind
        --
        theme.accent = accent
        --
        local window = {pages = {}, isVisible = false, uibind = guibind, currentPage = nil, fading = false, dragging = false, drag = Vector2.new(0,0), currentContent = {frame = nil, dropdown = nil, multibox = nil, colorpicker = nil, keybind = nil}}
        --
